	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case R.id.activate:
			...
			if(activateMe.getActive()) {
				// TODO
				// remove geofence if this is the last alert using corresponding geofence
				...
				for(Geofence g : mCurrentGeofences)
					if(Integer.parseInt(g.getRequestId()) == activateMe.getLocation()) 
						active = true;
				...
				// if not then create a new geofence corresponding to alert location
